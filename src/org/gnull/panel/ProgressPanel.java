...
public class ProgressPanel extends JPanel{
	...
	public ProgressPanel(MessagePanel messagepanel) {
		mp = messagepanel;
		createProgressPanel();
	}
	
	public ProgressPanelController getProgressPanelController() {
		return ppc;
	}
	...
	public void createProgressPanel() {
		...
		button = new JButton("ÔËÐÐ");
		ppc = new ProgressPanelController(progressbar, button, mp);
	...
	public MessagePanel getMessagePanelINProgressPanel() {
		return mp;
	}
